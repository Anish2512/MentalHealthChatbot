...
def chat_page():
    ...
    if a := st.chat_input("Whats on your mind today?"):
...
def main():
    ...
    st.markdown(
        f"<div class='personalized-greeting'>Good Morning <span class='personalized-name'>{st.session_state.user_name}</span>, Welcome to your Mental Health Assistant</div>",
        unsafe_allow_html=True
    )
